package com.example.dotted_lin_library.view;
...
import com.example.dotted_lin_library.R;

public class DottedLin extends View {
    ...
    public DottedLin(Context context, AttributeSet attrs) {
